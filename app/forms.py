...
class SignUpForm(UserCreationForm):
    ...
    email = forms.CharField(label='Email',widget=forms.EmailInput(attrs={'class':'form-control'}), max_length=50, required=True)
    class Meta:
        model = User
...
class LoginForm(AuthenticationForm):
    ...
    password = forms.CharField(label=_('Password'), max_length=50, required=True,widget=forms.EmailInput(attrs={'class':'form-control'}))
